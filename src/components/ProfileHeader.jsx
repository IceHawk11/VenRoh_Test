			...
			<div className='p-4'>
				...
				<div className='text-center mb-4'>
					...
					{isEditing ? (
						...
						{["Idea", "Start-Up", "Investor","Venture Capital Firm"].map((option) => (
							<label key={option} className="flex items-center space-x-2">
							<input
								type="radio"
								name="headline"
								value={option}
								checked={(editedData.headline ?? userData.headline) === option}
								onChange={(e) =>
				...
				{isOwnProfile ? (
					isEditing ? (
						<button
							className='w-full bg-black text-white py-2 px-4 rounded-full hover:bg-primary-dark
